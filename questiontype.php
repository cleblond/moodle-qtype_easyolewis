...
/**
 * Question type class for the easyolewis question type.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/easyolewis/question.php');
require_once($CFG->dirroot . '/question/type/shortanswer/questiontype.php');

//	echo "HERE";
/**
 * The easyolewis question type.
 *
 * @copyright  1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_easyolewis extends qtype_shortanswer {
    public function extra_question_fields() {
        return array('question_easyolewis', 'answers', 'chargeorlonepairs');
    }
 ...
 /*   function export_to_xml( $question, qformat_xml $format, $extra=null ) {
    ...
    function import_from_xml($data, $question, qformat_xml $format, $extra=null) {
        ...
        if ($data['@']['type'] == 'easyolewis') {

            // get common parts
            $question = $format->import_headers($data);

            // header parts particular to easyolewis
            $question->qtype = 'easyolewis';
